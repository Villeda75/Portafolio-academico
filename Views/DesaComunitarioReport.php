...
<head>
  ...
  <title>Reporte Desarrollo Comunitario JOVESOLIDES</title>
    ...
    <section id="services" class="services section-bg">
      <div class="container">
        ...
        <header class="section-header"> 
          <h3>Reporte de Desarrollo Comunitario</h3>
          <p>Visualice la cantidad de ex becarios que laboran en su dep. de proveniencia</p>
        </header>
        ...
        <script>
          ...
          var myChart = new Chart(ctx, {
              type: 'bar',
              data: {
                  labels: ['San Miguel', 'Morazán', 'San Vicente', 'La Libertad', 'Chalatenango'], //barras o categorías
                  datasets: [{
                      label: '# de ex becarios en desarollo comunitario', //titulo del graáfico
                      data: [2, 1, 2, 1, 4], //frecuencia
